package com.example.practicingkotlinandandroidstudio.lunchTray.data

import com.example.practicingkotlinandandroidstudio.lunchTray.constants.ItemType
import com.example.practicingkotlinandandroidstudio.lunchTray.model.MenuItem

//Карта доступных пунктов прейскуранта, которые будут отображаться во фрагментах меню
