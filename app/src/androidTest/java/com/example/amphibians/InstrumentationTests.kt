...
import com.example.practicingkotlinandandroidstudio.MainActivity
import com.example.practicingkotlinandandroidstudio.amphibians.ui.AmphibianListFragment
...
class InstrumentationTests : BaseTest() {
    ...
    fun `recycler_view_content`() {
        launchFragmentInContainer<AmphibianListFragment>(themeResId = R.style.Theme_Amp)
