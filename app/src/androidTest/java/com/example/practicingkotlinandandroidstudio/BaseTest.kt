...
import com.example.practicingkotlinandandroidstudio.DrawableMatcher.withDrawable
...
open class BaseTest {
    ...
    fun testState(textActionResources: Int, drawableResources: Int) {
        onView(withId(R.id.text_action))
            .check(matches(ViewMatchers.withText(textActionResources)))
    }
